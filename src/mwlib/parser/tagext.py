...
tags_to_ignore = ["chem", "chess", "choose", "dpl", "dynamicpagelist", "feyn", "forum", "go", "googlemapkml", "graph", "greek", "ling", "plot", "ppch", "randomimage", "schem", "staff", "teng", "tipa", "verbatim", "aoaudio", "aovideo", "bloglist", "cgamer", "ggtube", "googlemap", "gtrailer", "gvideo", "nicovideo", "tangler", "video", "videogallery", "wegame", "youtube", "imagelink", "badge", "comments", "createform", "fan", "featuredimage", "gallerypopulate", "linkfilter", "listpages", "loggedin", "loggedout", "newusers", "pagequality", "pollembed", "randomfeatureduser", "randomgameunit", "randomimagebycategory", "randomuserswithavatars", "rss", "siteactivity", "templatestyles", "userpoll", "videogallerypopulate", "vote", "welcomeuser", "xsound", "pageby", "uml", "graphviz", "categorytree", "summary", "slippymap"]
